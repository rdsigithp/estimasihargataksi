...
def main():
    ...
    st.image("https://assets.streamlit.io/images/brand/streamlit-logo-secondary-colormark-darktext.png", width=300)  # Menampilkan logo mobil dari Streamlit dengan lebar 300 pixel
